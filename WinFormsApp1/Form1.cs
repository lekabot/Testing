...
namespace WinFormsApp1
{
    public partial class Form1 : Form, IUserInfo
    {
        ...
        string IUserInfo.PlaceOfResidence { get => this.PlaceOfResidence.Text; set => this.PlaceOfResidence.Text = value; }
        string IUserInfo.Gender { get => this.Gender.Text; set => this.Gender.Text = value; }
